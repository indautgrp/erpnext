...
def execute(filters=None):
	...
	columns = [_("Voucher Type") + "::110",
		_("Voucher No") + ":Dynamic Link/Voucher Type:120", _("Posting Date") + ":Date",
	...
	for row in source:
		...
		data.append([row.parenttype,row.name, row.posting_date, row.item_code, row.item_name, row.item_group,
