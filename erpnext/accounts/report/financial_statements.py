...
def get_data(company, root_type, balance_must_be, period_list, 
	...
	calculate_values(accounts_by_name, gl_entries_by_account, period_list, accumulated_values, only_current_fiscal_year)
...
def calculate_values(accounts_by_name, gl_entries_by_account, period_list, accumulated_values, only_current_fiscal_year):
