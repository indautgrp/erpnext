...
def get_data(company, root_type, balance_must_be, period_list, accumulated_value, ignore_closing_entries=False):
	...
	calculate_values(accounts, gl_entries_by_account, period_list, accumulated_value_ischecked)
...
def calculate_values(accounts, gl_entries_by_account, period_list, accumulated_value_ischecked):
